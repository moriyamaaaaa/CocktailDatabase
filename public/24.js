        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              list = _yield$axios$get.data.result.Paraphrases;
              _this.paraphrases = list;
  ...
  methods: {
    setForm: function setForm(_ref) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var name, converted, middle, note, command, _yield$axios$post, _yield$axios$post$dat, convertedName, middleName, categoryId, middleId, brandId;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                name = _ref.name, converted = _ref.converted, middle = _ref.middle, note = _ref.note, command = _ref.command;
                //子コンポーネントからパラメータを受け入れるので、更新する
                _this2.name = name;
                _this2.note = note;
                _this2.command = command; //convertedは文字列になっちゃってるので、探して取得
              ...
              case 6:
                ...
                convertedName = _yield$axios$post$dat.converted;
                middleName = _yield$axios$post$dat.middle;
                categoryId = _yield$axios$post$dat.categoryId;
                middleId = _yield$axios$post$dat.middleId;
                brandId = _yield$axios$post$dat.brandId;

                if (brandId) {
                  console.log("ｂらんｄ" + brandId);
                  _this2.$refs.ParaPhrase.selected_brand = {
                    value: brandId
                  };
                } else if (middleId) {
                  console.log("みっｄぇ" + middleId);
                  _this2.$refs.ParaPhrase.selected_middle = {
                    value: middleId
                  };
                } else {
                  console.log("かてごｒｙ" + categoryId);
                  _this2.$refs.ParaPhrase.selectedCategory = {
                    value: categoryId
                  };
                }
      ...
      [
        ...
        _c("CategorySelect", {
          ...
          attrs: {
            ...
            "initial-category": _vm.selectedCategory,
            "initial-middle": _vm.selectedMiddle,
            "initial-brand": _vm.selectedBrand
          }
        })
      ],
      1
