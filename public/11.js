      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              _yield$axios$post = _context.sent;
              middle = _yield$axios$post.data.result.middle;
              _context.next = 12;
              break;
            ...
            case 12:
              _this.detailEditObj.name = middle.name;
              _this.detailEditObj.name_eng = middle.name_eng;
              _this.detailEditObj.description = middle.description;
              _this.detailEditObj.youtube = middle.youtube;
              _this.detailEditObj.youtube_time_hour = middle.y_hour;
              _this.detailEditObj.youtube_time_minute = middle.y_minute;
              _this.detailEditObj.youtube_time_second = middle.y_second;
              _this.detailEditObj.link_txt = middle.image_txt;
              _this.detailEditObj.link_url = middle.image_url;
              _this.detailEditObj.is_major = middle.is_major;
              _this.detailEditObj.is_like = middle.is_like;
              _this.detailEditObj.is_powder = middle.is_powder;
              _this.detailEditObj.uploadImageUrl = middle.image;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                //データを送信する
                //データのバリデーション
                array = [_this4.$refs.categorySelect.validateObj, _this4.$refs.middleForm.validateObj]; //もし「親カテゴリ」がその他だった場合は、この部分のバリデーションが不要になる

                _context2.next = 3;
                return axios.post("http://127.0.0.1:8000" + '/Cocktail/iskind5/check', {
                  id: _this4.selectedCategory.value
                });
              ...
              case 9:
                _context2.prev = 9;
                _context2.next = 12;
                return axios.post("http://127.0.0.1:8000" + '/admin/submit/middle', _this4.formdata, {
                  headers: {
