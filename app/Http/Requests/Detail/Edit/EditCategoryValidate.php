...
class EditCategoryValidate extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $return=[
            ...
            "name" => "required",
            "name_eng" => "required",
            "kind" => "required|integer|min:1|max:5",
            "description" => "required",
            "youtube_time_hour" => "nullable|integer|min:1",
            "youtube_time_minute" => "nullable|integer|min:0|max:59",
            "youtube_time_second" => "nullable|integer|min:0|max:59",
        ...
        $brandValids=[
            ...
            "brand_youtube_time_hour" => "nullable|integer|min:1",
            "brand_youtube_time_minute" => "nullable|integer|max:59",
            "brand_youtube_time_second" => "nullable|integer|max:59",
        ...
        if(KindFactory::is_kind5_fromKindId($this->kind)===true){
            $this->is_kind5=true;
